...
const LecturerEditAssignmentModal = ({ handleShowAssignmentModal, Title , id }: ShowMoadalType) => {
  ...
  const auth = useAuthUser();
   ...
   const { studentsdata, assignmentsdata} = useAssignmentCardClicked(id);

   console.log('assignment',assignmentsdata);
...
export default LecturerEditAssignmentModal;
